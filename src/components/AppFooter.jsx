...
const AppFooter = () => {
  ...
  return (
    <footer className="bg-[#0A0B14] text-white py-20 px-10 border-t border-white/5 font-sans">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-16 mb-20">
          ...
          <div className="lg:col-span-3 space-y-8">
            ...
            <Typography className="text-gray-400 text-sm leading-7 max-w-sm font-medium">
          ...
          {footerSections.map((section) => (
            <div key={section.title} className="lg:col-span-2 space-y-7">
              <Typography className="text-[11px] font-black uppercase tracking-[0.35em] text-white">
                {section.title}
              </Typography>
                ...
                {section.links.map((link) => (
                  <li key={link}>
                    <Link
                      ...
                      className="text-gray-500 text-[13.5px] font-medium hover:text-white transition-colors text-left bg-transparent border-none p-0"
                    >
                      {link}
                    </Link>
                  </li>
          ...
          <div className="lg:col-span-3 space-y-7">
            ...
            <Typography className="text-gray-500 text-[13.5px] font-medium leading-[1.7] max-w-[260px]">
            ...
            <div className="space-y-4">
              <input
                ...
                className="w-full bg-[#151720] border border-white/5 rounded-xl px-4 py-3 text-sm text-white placeholder:text-gray-700 focus:outline-none focus:border-indigo-500/40 focus:ring-1 focus:ring-indigo-500/20 transition-all"
              />
        ...
        <div className="pt-8 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-10 text-gray-500">
            <Typography className="text-[11.5px] font-bold tracking-tight">
          ...
          <button className="flex items-center gap-2 text-gray-500 hover:text-white transition-colors bg-transparent border-none p-0">
            <GlobeAltIcon className="h-4.5 w-4.5" />
            <span className="text-[11.5px] font-bold tracking-tight">
              English (US)
            </span>
            <ChevronDownIcon className="h-3 w-3 mt-0.5 opacity-50" />
          </button>
        </div>
      </div>
    </footer>
