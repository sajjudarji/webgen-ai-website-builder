...
const AIAssistant = () => {
    ...
    try {
      ...
      alert(
        serverMessage
          ...
          : "Failed to generate layout. Please check your connection.",
      );
    } finally {
  ...
  return (
    <div className="fixed bottom-8 left-1/2 -translate-x-1/2 z-[50]">
      ...
      >
        <div className="mx-auto w-full max-w-[500px] rounded-[2.5rem] border border-white/50 bg-white/80 backdrop-blur-2xl shadow-2xl overflow-hidden">
              ...
              <Menu placement="bottom-end">
                <MenuHandler>
                  <div className="px-4 py-2 cursor-pointer bg-white border border-gray-200 text-gray-700 rounded-xl flex items-center justify-between shadow-sm outline-none min-w-[160px] hover:border-indigo-300 transition-all">
                    ...
                    <ChevronDownIcon
                      strokeWidth={2.5}
                      className="h-3 w-3 ml-2 text-indigo-400"
                    />
                  </div>
                </MenuHandler>
